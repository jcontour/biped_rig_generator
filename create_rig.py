...
def generate_rig():
    ...
    c.orientConstraint('fk_r_shld_cc', 'fk_r_shld', mo=False, n='fk_r_shld_const')
    c.orientConstraint('fk_r_elbow_cc', 'fk_r_elbow', mo=False, n='fk_r_elbow_const')
    c.orientConstraint('fk_r_wrist_cc', 'fk_r_wrist', mo=False, n='fk_r_elbow_const')
    ...
    # connect controls to jnts
    c.orientConstraint('fk_l_shld_cc', 'fk_l_shld', mo=False, n='fk_l_shld_const')
    c.orientConstraint('fk_l_elbow_cc', 'fk_l_elbow', mo=False, n='fk_l_elbow_const')
    c.orientConstraint('fk_l_wrist_cc', 'fk_l_wrist', mo=False, n='fk_l_wrist_const')
    ...
    c.makeIdentity( apply=True )
    # make elbow ctrl
    c.circle(n='ik_r_elbow_cc')
    c.delete(ch=True)
    # position elbow
    c.parentConstraint('ik_r_elbow', 'ik_r_elbow_cc', mo=False, n='const')
    c.delete('const')
    c.scale(0.25, 0.25, 0.25)
    c.setAttr('ik_r_elbow_cc.tz', -4)
    c.makeIdentity( apply=True )
    # connect
    c.pointConstraint('ik_r_arm_cc', 'ik_r_arm', n='ik_r_arm_const')
    c.orientConstraint('ik_r_arm_cc', 'ik_r_wrist', n='ik_r_wrist_const')
    c.select('ik_r_arm')
    c.setAttr('ik_r_arm.visibility', False)
    c.setAttr( 'ik_r_arm_cc.visibility', k=False, cb=False)
    
    c.poleVectorConstraint( 'ik_r_elbow_cc', 'ik_r_arm', n='ik_r_elbow_const')
    ...
    c.makeIdentity( apply=True )
    # make elbow ctrl
    c.circle(n='ik_l_elbow_cc')
    c.delete(ch=True)
    # position elbow
    c.parentConstraint('ik_l_elbow', 'ik_l_elbow_cc', mo=False, n='const')
    c.delete('const')
    c.scale(0.25, 0.25, 0.25)
    c.setAttr('ik_l_elbow_cc.tz', -4)
    c.makeIdentity( apply=True )
    # connect
    c.pointConstraint('ik_l_arm_cc', 'ik_l_arm', n='ik_l_arm_const')
    c.orientConstraint('ik_l_arm_cc', 'ik_l_wrist', n='ik_l_wrist_const')
    c.select('ik_l_arm')
    c.setAttr('ik_l_arm.visibility', False)
    c.setAttr( 'ik_l_arm_cc.visibility', k=False, cb=False)
    c.poleVectorConstraint( 'ik_l_elbow_cc', 'ik_l_arm', n='ik_l_elbow_const')
    
    # ------------------ CONNECT IK/FK CHAINS TO DRIVER CHAIN
    c.orientConstraint( 'fk_r_shld', 'ik_r_shld', 'jnt_r_shld', n='ikfk_r_shld_const' )
    c.orientConstraint( 'fk_r_elbow', 'ik_r_elbow', 'jnt_r_elbow', n='ikfk_r_elbow_const' )
    c.orientConstraint( 'fk_r_wrist', 'ik_r_wrist', 'jnt_r_wrist', n='ikfk_r_wrist_const' )
    
    c.orientConstraint( 'fk_l_shld', 'ik_l_shld', 'jnt_l_shld', n='ikfk_l_shld_const' )
    c.orientConstraint( 'fk_l_elbow', 'ik_l_elbow', 'jnt_l_elbow', n='ikfk_l_elbow_const' )
    c.orientConstraint( 'fk_l_wrist', 'ik_l_wrist', 'jnt_l_wrist', n='ikfk_l_wrist_const' )
    ...
    c.select('ikfk_r_wrist_const')
    c.setAttr('ikfk_r_wrist_const.fk_r_wristW0', 1)
    c.setAttr('ikfk_r_wrist_const.ik_r_wristW1', 0)
    c.setDrivenKeyframe( at='fk_r_wristW0', cd='IKFK_r_cc.IKFK' )
    c.setDrivenKeyframe( at='ik_r_wristW1', cd='IKFK_r_cc.IKFK' )
    
    c.select('ikfk_r_elbow_const')
    c.setAttr('ikfk_r_elbow_const.fk_r_elbowW0', 1)
    c.setAttr('ikfk_r_elbow_const.ik_r_elbowW1', 0)
    c.setDrivenKeyframe( at='fk_r_elbowW0', cd='IKFK_r_cc.IKFK' )
    c.setDrivenKeyframe( at='ik_r_elbowW1', cd='IKFK_r_cc.IKFK' )
    
    c.select('ikfk_r_shld_const')
    c.setAttr('ikfk_r_shld_const.fk_r_shldW0', 1)
    c.setAttr('ikfk_r_shld_const.ik_r_shldW1', 0)
    c.setDrivenKeyframe( at='fk_r_shldW0', cd='IKFK_r_cc.IKFK' )
    c.setDrivenKeyframe( at='ik_r_shldW1', cd='IKFK_r_cc.IKFK' )
    ...
    c.select('ikfk_l_wrist_const')
    c.setAttr('ikfk_l_wrist_const.fk_l_wristW0', 1)
    c.setAttr('ikfk_l_wrist_const.ik_l_wristW1', 0)
    c.setDrivenKeyframe( at='fk_l_wristW0', cd='IKFK_l_cc.IKFK' )
    c.setDrivenKeyframe( at='ik_l_wristW1', cd='IKFK_l_cc.IKFK' )
    
    c.select('ikfk_l_elbow_const')
    c.setAttr('ikfk_l_elbow_const.fk_l_elbowW0', 1)
    c.setAttr('ikfk_l_elbow_const.ik_l_elbowW1', 0)
    c.setDrivenKeyframe( at='fk_l_elbowW0', cd='IKFK_l_cc.IKFK' )
    c.setDrivenKeyframe( at='ik_l_elbowW1', cd='IKFK_l_cc.IKFK' )
    
    c.select('ikfk_l_shld_const')
    c.setAttr('ikfk_l_shld_const.fk_l_shldW0', 1)
    c.setAttr('ikfk_l_shld_const.ik_l_shldW1', 0)
    c.setDrivenKeyframe( at='fk_l_shldW0', cd='IKFK_l_cc.IKFK' )
    c.setDrivenKeyframe( at='ik_l_shldW1', cd='IKFK_l_cc.IKFK' )
    ...
    c.setDrivenKeyframe( at='visibility', cd='IKFK_l_cc.IKFK' )
    c.select('ik_l_elbow_cc')
    c.setAttr('ik_l_elbow_cc.visibility', False)
    c.setDrivenKeyframe( at='visibility', cd='IKFK_l_cc.IKFK' )
    ...
    c.makeIdentity( apply=True )
    # make knee ctrl
    c.circle(n='ik_r_knee_cc')
    c.delete(ch=True)
    # position knee
    c.parentConstraint('jnt_r_knee', 'ik_r_knee_cc', mo=False, n='const')
    c.delete('const')
    c.scale(0.25, 0.25, 0.25)
    c.setAttr('ik_r_knee_cc.tz', 4)
    c.makeIdentity( apply=True )
    
    # connect
    c.pointConstraint('ik_r_leg_cc', 'ik_r_leg', n='ik_r_leg_const')
    c.orientConstraint('ik_r_leg_cc', 'jnt_r_ankle', mo=True, n='ik_r_ankle_const')
    c.select('ik_r_leg')
    c.setAttr('ik_r_leg.visibility', False)
    c.setAttr( 'ik_r_leg_cc.visibility', k=False, cb=False)
    c.poleVectorConstraint('ik_r_knee_cc', 'ik_r_leg', n='ik_r_knee_const')
    # LEFT IK
    # create IK chain
    ...
    c.makeIdentity( apply=True )
	# make knee ctrl
    c.circle(n='ik_l_knee_cc')
    c.delete(ch=True)
    # position knee
    c.parentConstraint('jnt_l_knee', 'ik_l_knee_cc', mo=False, n='const')
    c.delete('const')
    c.scale(0.25, 0.25, 0.25)
    c.setAttr('ik_l_knee_cc.tz', 4)
    c.makeIdentity( apply=True )
    # connect
    c.pointConstraint('ik_l_leg_cc', 'ik_l_leg', n='ik_l_leg_const')
    c.orientConstraint('ik_l_leg_cc', 'jnt_l_ankle', mo=True, n='ik_l_ankle_const')
    c.select('ik_l_leg')
    c.setAttr('ik_l_leg.visibility', False)
    c.setAttr( 'ik_l_leg_cc.visibility', k=False, cb=False)
    c.poleVectorConstraint( 'ik_l_knee_cc', 'ik_l_leg', n='ik_l_knee_const')
    ...
    c.parentConstraint('cc_cog', 'jnt_cog', mo=True, n='cog_const')
    c.orientConstraint('cc_spine', 'jnt_spine', mo=True, n='spine_const')
    c.orientConstraint('cc_chest', 'jnt_chest', mo=True, n='chest_const')
    c.orientConstraint('cc_neck', 'jnt_neck', mo=True, n='neck_const')
    c.orientConstraint('cc_head', 'jnt_head', mo=True, n='head_const')
    c.orientConstraint('cc_hula', 'jnt_hula', mo=True, n='hula_const')
    ...
    # CLEANUP
    c.setAttr( 'cc_cog.scaleX', k=False, cb=False)
    c.setAttr( 'cc_cog.scaleY', k=False, cb=False)
    c.setAttr( 'cc_cog.scaleZ', k=False, cb=False)
    c.setAttr( 'cc_cog.visibility', k=False, cb=False)
    c.setAttr( 'cc_hula.translateX', k=False, cb=False)
    c.setAttr( 'cc_hula.translateY', k=False, cb=False)
    c.setAttr( 'cc_hula.translateZ', k=False, cb=False)
    c.setAttr( 'cc_hula.scaleX', k=False, cb=False)
    c.setAttr( 'cc_hula.scaleY', k=False, cb=False)
    c.setAttr( 'cc_hula.scaleZ', k=False, cb=False)
    c.setAttr( 'cc_hula.visibility', k=False, cb=False)
    c.setAttr( 'cc_chest.translateX', k=False, cb=False)
    c.setAttr( 'cc_chest.translateY', k=False, cb=False)
    c.setAttr( 'cc_chest.translateZ', k=False, cb=False)
    c.setAttr( 'cc_chest.scaleX', k=False, cb=False)
    c.setAttr( 'cc_chest.scaleY', k=False, cb=False)
    c.setAttr( 'cc_chest.scaleZ', k=False, cb=False)
    c.setAttr( 'cc_chest.visibility', k=False, cb=False)
    c.setAttr( 'cc_neck.translateX', k=False, cb=False)
    c.setAttr( 'cc_neck.translateY', k=False, cb=False)
    c.setAttr( 'cc_neck.translateZ', k=False, cb=False)
    c.setAttr( 'cc_neck.scaleX', k=False, cb=False)
    c.setAttr( 'cc_neck.scaleY', k=False, cb=False)
    c.setAttr( 'cc_neck.scaleZ', k=False, cb=False)
    c.setAttr( 'cc_neck.visibility', k=False, cb=False)
    c.setAttr( 'cc_head.translateX', k=False, cb=False)
    c.setAttr( 'cc_head.translateY', k=False, cb=False)
    c.setAttr( 'cc_head.translateZ', k=False, cb=False)
    c.setAttr( 'cc_head.scaleX', k=False, cb=False)
    c.setAttr( 'cc_head.scaleY', k=False, cb=False)
    c.setAttr( 'cc_head.scaleZ', k=False, cb=False)
    c.setAttr( 'cc_head.visibility', k=False, cb=False)
    c.setAttr( 'fk_r_shld_cc.translateX', k=False, cb=False)
    c.setAttr( 'fk_r_shld_cc.translateY', k=False, cb=False)
    c.setAttr( 'fk_r_shld_cc.translateZ', k=False, cb=False)
    c.setAttr( 'fk_r_shld_cc.scaleX', k=False, cb=False)
    c.setAttr( 'fk_r_shld_cc.scaleY', k=False, cb=False)
    c.setAttr( 'fk_r_shld_cc.scaleZ', k=False, cb=False)
    c.setAttr( 'fk_r_shld_cc.visibility', k=False, cb=False)
    c.setAttr( 'fk_r_elbow_cc.translateX', k=False, cb=False)
    c.setAttr( 'fk_r_elbow_cc.translateY', k=False, cb=False)
    c.setAttr( 'fk_r_elbow_cc.translateZ', k=False, cb=False)
    c.setAttr( 'fk_r_elbow_cc.scaleX', k=False, cb=False)
    c.setAttr( 'fk_r_elbow_cc.scaleY', k=False, cb=False)
    c.setAttr( 'fk_r_elbow_cc.scaleZ', k=False, cb=False)
    c.setAttr( 'fk_r_elbow_cc.visibility', k=False, cb=False)
    c.setAttr( 'fk_r_wrist_cc.translateX', k=False, cb=False)
    c.setAttr( 'fk_r_wrist_cc.translateY', k=False, cb=False)
    c.setAttr( 'fk_r_wrist_cc.translateZ', k=False, cb=False)
    c.setAttr( 'fk_r_wrist_cc.scaleX', k=False, cb=False)
    c.setAttr( 'fk_r_wrist_cc.scaleY', k=False, cb=False)
    c.setAttr( 'fk_r_wrist_cc.scaleZ', k=False, cb=False)
    c.setAttr( 'fk_r_wrist_cc.visibility', k=False, cb=False)
    c.setAttr( 'fk_l_shld_cc.translateX', k=False, cb=False)
    c.setAttr( 'fk_l_shld_cc.translateY', k=False, cb=False)
    c.setAttr( 'fk_l_shld_cc.translateZ', k=False, cb=False)
    c.setAttr( 'fk_l_shld_cc.scaleX', k=False, cb=False)
    c.setAttr( 'fk_l_shld_cc.scaleY', k=False, cb=False)
    c.setAttr( 'fk_l_shld_cc.scaleZ', k=False, cb=False)
    c.setAttr( 'fk_l_shld_cc.visibility', k=False, cb=False)
    c.setAttr( 'fk_l_elbow_cc.translateX', k=False, cb=False)
    c.setAttr( 'fk_l_elbow_cc.translateY', k=False, cb=False)
    c.setAttr( 'fk_l_elbow_cc.translateZ', k=False, cb=False)
    c.setAttr( 'fk_l_elbow_cc.scaleX', k=False, cb=False)
    c.setAttr( 'fk_l_elbow_cc.scaleY', k=False, cb=False)
    c.setAttr( 'fk_l_elbow_cc.scaleZ', k=False, cb=False)
    c.setAttr( 'fk_l_elbow_cc.visibility', k=False, cb=False)
    c.setAttr( 'fk_l_wrist_cc.translateX', k=False, cb=False)
    c.setAttr( 'fk_l_wrist_cc.translateY', k=False, cb=False)
    c.setAttr( 'fk_l_wrist_cc.translateZ', k=False, cb=False)
    c.setAttr( 'fk_l_wrist_cc.scaleX', k=False, cb=False)
    c.setAttr( 'fk_l_wrist_cc.scaleY', k=False, cb=False)
    c.setAttr( 'fk_l_wrist_cc.scaleZ', k=False, cb=False)
    c.setAttr( 'fk_l_wrist_cc.visibility', k=False, cb=False)
    c.setAttr( 'ik_l_arm_cc.scaleX', k=False, cb=False)
    c.setAttr( 'ik_l_arm_cc.scaleY', k=False, cb=False)
    c.setAttr( 'ik_l_arm_cc.scaleZ', k=False, cb=False)
    c.setAttr( 'ik_l_arm_cc.visibility', k=False, cb=False)
    c.setAttr( 'ik_r_arm_cc.scaleX', k=False, cb=False)
    c.setAttr( 'ik_r_arm_cc.scaleY', k=False, cb=False)
    c.setAttr( 'ik_r_arm_cc.scaleZ', k=False, cb=False)
    c.setAttr( 'ik_r_arm_cc.visibility', k=False, cb=False)
    c.setAttr( 'ik_l_leg_cc.scaleX', k=False, cb=False)
    c.setAttr( 'ik_l_leg_cc.scaleY', k=False, cb=False)
    c.setAttr( 'ik_l_leg_cc.scaleZ', k=False, cb=False)
    c.setAttr( 'ik_l_leg_cc.visibility', k=False, cb=False)
    c.setAttr( 'ik_r_leg_cc.scaleX', k=False, cb=False)
    c.setAttr( 'ik_r_leg_cc.scaleY', k=False, cb=False)
    c.setAttr( 'ik_r_leg_cc.scaleZ', k=False, cb=False)
    c.setAttr( 'ik_r_leg_cc.visibility', k=False, cb=False)
    c.setAttr( 'ik_r_elbow_cc.rotateX', k=False, cb=False)
    c.setAttr( 'ik_r_elbow_cc.rotateY', k=False, cb=False)
    c.setAttr( 'ik_r_elbow_cc.rotateZ', k=False, cb=False)
    c.setAttr( 'ik_r_elbow_cc.scaleX', k=False, cb=False)
    c.setAttr( 'ik_r_elbow_cc.scaleY', k=False, cb=False)
    c.setAttr( 'ik_r_elbow_cc.scaleZ', k=False, cb=False)
    c.setAttr( 'ik_r_elbow_cc.visibility', k=False, cb=False)
    c.setAttr( 'ik_l_elbow_cc.rotateX', k=False, cb=False)
    c.setAttr( 'ik_l_elbow_cc.rotateY', k=False, cb=False)
    c.setAttr( 'ik_l_elbow_cc.rotateZ', k=False, cb=False)
    c.setAttr( 'ik_l_elbow_cc.scaleX', k=False, cb=False)
    c.setAttr( 'ik_l_elbow_cc.scaleY', k=False, cb=False)
    c.setAttr( 'ik_l_elbow_cc.scaleZ', k=False, cb=False)
    c.setAttr( 'ik_l_elbow_cc.visibility', k=False, cb=False)
    c.setAttr( 'ik_r_knee_cc.rotateX', k=False, cb=False)
    c.setAttr( 'ik_r_knee_cc.rotateY', k=False, cb=False)
    c.setAttr( 'ik_r_knee_cc.rotateZ', k=False, cb=False)
    c.setAttr( 'ik_r_knee_cc.scaleX', k=False, cb=False)
    c.setAttr( 'ik_r_knee_cc.scaleY', k=False, cb=False)
    c.setAttr( 'ik_r_knee_cc.scaleZ', k=False, cb=False)
    c.setAttr( 'ik_r_knee_cc.visibility', k=False, cb=False)
    c.setAttr( 'ik_l_knee_cc.rotateX', k=False, cb=False)
    c.setAttr( 'ik_l_knee_cc.rotateY', k=False, cb=False)
    c.setAttr( 'ik_l_knee_cc.rotateZ', k=False, cb=False)
    c.setAttr( 'ik_l_knee_cc.scaleX', k=False, cb=False)
    c.setAttr( 'ik_l_knee_cc.scaleY', k=False, cb=False)
    c.setAttr( 'ik_l_knee_cc.scaleZ', k=False, cb=False)
    c.setAttr( 'ik_l_knee_cc.visibility', k=False, cb=False)
    
    c.group('jnt_cog', n='jnts')
    c.group(['cc_cog', 'ik_r_arm_cc', 'ik_l_arm_cc', 'ik_r_leg_cc', 'ik_l_leg_cc', 'ik_r_elbow_cc', 'ik_l_elbow_cc', 'ik_r_knee_cc', 'ik_l_knee_cc'], n='ccs')
    c.group(['ik_r_arm', 'ik_l_arm', 'ik_r_leg', 'ik_l_leg'], n='iks')
    c.setAttr('iks.visibility', False)
    c.setAttr('ik_r_shld.visibility', False)
    c.setAttr('ik_l_shld.visibility', False)
    c.setAttr('fk_l_shld.visibility', False)
    c.setAttr('fk_l_shld.visibility', False)
    c.setAttr('fk_r_shld.visibility', False)
    c.setAttr('fk_r_shld.visibility', False)
